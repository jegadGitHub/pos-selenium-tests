...
public class DriverInstance{
	...
	public void setDriver(String browser, boolean headless) throws MalformedURLException {		
		...
		case "chrome":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://52.172.196.172:32000/wd/hub"), options));
			break;
		case "firefox":
			...
			remoteWebdriver.set(new RemoteWebDriver(new URL("http://52.172.196.172:32000/wd/hub"), firefoxOptions));
			break;
		case "edge":
